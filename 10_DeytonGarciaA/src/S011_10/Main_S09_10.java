...
public class Main_S09_10 {
 public static void main(String[] args) {
        ...
        // Ejemplo de suma
        double resultadoSuma = Calculadora_10.sumar(10, 5);
        System.out.println("Suma: " + resultadoSuma);

        // Ejemplo de resta
        double resultadoResta = Calculadora_10.restar(10, 5);
        System.out.println("Resta: " + resultadoResta);

        // Ejemplo de multiplicación
        double resultadoMultiplicacion = Calculadora_10.multiplicar(10, 5);
        System.out.println("Multiplicación: " + resultadoMultiplicacion);

        // Ejemplo de división
        double resultadoDivision = Calculadora_10.dividir(10, 5);
